      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-4 float-sm-right">
            <h1>Manage Approved Comments</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
               <li class="breadcrumb-item "><a href="#" class="">Admin</a></li>
               <li class="breadcrumb-item "><a href="#" class="">Comments</a></li>
               <li class="breadcrumb-item "><a href="#" class="text-secondary">Approved Comments</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <table class="table align-middle mt-5 mb-0 bg-white">
         ...
         <tbody>
           ...
           <tr>
            <td>2</td>
            <td>Rajan kumar</td>
            <td>rajankumardbg123@gmail.com</td>
            <td>
                <p>Approved</p>
            </td>
             <td>
